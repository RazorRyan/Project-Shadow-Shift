import { BASE_CANVAS_WIDTH, BASE_CANVAS_HEIGHT, MAX_PARTICLES, MAX_SLASH_EFFECTS, SAVE_KEY, COLORS } from "./engine/constants";
import { clamp, approachValue, hexToRgb, hexToRgba, multiplyHex } from "./engine/utils";
import { createRect, aabbOverlap, collectWorldSolids, resolveHorizontal, resolveVertical, probeOverlap } from "./engine/collision";
...
import { ensureReactiveState, getReactivePulse, setReactiveFlag, getReactiveFlag, updateReactiveTimers, triggerReactiveObject } from "./engine/reactivity";
import { ensurePuzzleRuntime, triggerPuzzleNode, updatePuzzleState, isPuzzleActive, getPuzzleNodeState } from "./engine/puzzles";
